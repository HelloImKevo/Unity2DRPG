...
public class Enemy_MageRetreatState : EnemyState
{
    ...
    public override void Enter()
    {
        ...
        {
            Debug.Log($"{enemy.gameObject.name} Entering MAGE ECHO RETREAT state");
        }
        ...
        // Make the enemy face the Player before performing its Dash-Backwards-Echo ability.
        enemy.HandleFlip(DirectionToPlayer());
        // Make the enemy invulnerable during its backwards-retreat ability.
